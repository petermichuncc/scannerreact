...
Template.allopworkcell.topGenresChart = function() {
...
var datatest=ReactiveMethod.call('averageallopworkcenters',Session.get("operator"),Session.get("startgraph"),Session.get("endgraph"))
...
Template.allopworkcell.rendered = function(){
     


};

Template.allopworkcell.helpers({
    timeframe: function () {
/*
