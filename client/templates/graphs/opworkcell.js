...
var datatest=ReactiveMethod.call('averagesingleworkcenter',Session.get("workcenterName"),Session.get("operator"),Session.get("startgraph"),Session.get("endgraph"))
